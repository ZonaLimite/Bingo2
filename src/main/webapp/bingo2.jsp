...
<table class="tablero">
    <tr>
      ...
      <td rowspan="10" class="panel" width="30%" >
...
<div id="GameStatus" class="GamerSatus">
<div class="content2">

<table id="resultLines"  border="1" align="center" class="Tabla">
  <tr bgcolor="#003399" id="fila">
    <td colspan="1"><label class="soloCaja" >CAJA <br></label>
      
        <input  class="Caja" type="text" Id="precioCarton2" value="120 €">
    
    
    <td colspan="1">
      <label class="soloCaja" >CARTON<br>
      </label ><input  class="Caja" type="text" Id="precioCarton" value="12 €">
    </td>
   <td colspan="2">
      <label class="soloCaja" >JUGADORES<br>
      </label ><input  class="Caja" type="text" Id="precioCarton" value="14">
    <br></td> 
  </tr>
...
<table id="resultLines2" border="1" align="center" class="Tabla">

  <tr>
    <td width="45%"class="Cabecera">USUARIOS</td>
    <td width="20%"  class="Cabecera">SALDO</td>
    <td width="15%" class="Cabecera">CARDS</td>
    <td width="20%"  class="Cabecera">PERFIL</td>
  </tr>
</table>
</div>
...
<tr onclick="valorCombo('elnombre')" class="fondosLineas" id="fila">
    <td width ="50%" class="otro"><label class="AIzquierdas">Lola Arranz</label></td>
    <td width ="20%" class="otro"><label class="AIzquierdas">120 €</label></td>
    <td  width ="15%" class="otroCentro"><label class="AIzquierdas">6</label></td>
    <td width ="15%" class="otroCentro"><label class="AIzquierdas">Manual</label></td>
</tr>
<tr onclick="valorCombo('elnombre')" class="fondosLineas" id="fila">
    <td width ="48%" class="otro"><label class="AIzquierdas">Paco Boga</label></td>
    <td width ="28%" class="otro"><label class="AIzquierdas">100 €</label></td>
    <td  width ="7%" class="otroCentro"><label class="AIzquierdas">2</label></td>
    <td width ="17%" class="otroCentro"><label class="AIzquierdas">Digital</label></td>
</tr>
